...
public class FiltroEdadSoa extends AppCompatActivity {
    ...
    private void llamarEndPoint(String fechaInicio, boolean incluirEstadoIng) {
        Call<List<Map<String, Object>>> call = soaService.obtenerEdadSimpleSoa(fechaInicio, fechaInicio, incluirEstadoIng);
