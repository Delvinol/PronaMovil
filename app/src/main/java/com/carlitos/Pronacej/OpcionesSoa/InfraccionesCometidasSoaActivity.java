...
public class InfraccionesCometidasSoaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_infraccion_soa);
        ...
        opcion1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intentOpcion1 = new Intent(InfraccionesCometidasSoaActivity.this, ResultadosDelitoSoa.class);
        ...
        opcion2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intentOpcion2 = new Intent(InfraccionesCometidasSoaActivity.this, ResultadosSituacionJuridicaActualSoa.class);
        ...
        opcion3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Iniciar la actividad correspondiente al presionar el ConstraintLayout 2
                Intent intentOpcion3 = new Intent(InfraccionesCometidasSoaActivity.this, ResultadosSituacionJuridicaIngresoSoa.class);
