...
import com.carlitos.Pronacej.ResultadosSoa.ResultadosSaludMentalSoa;
...
public class TratamientoDiferenciadoSoaActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        opcion4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Iniciar la actividad correspondiente al presionar el ConstraintLayout 2
                Intent intentOpcion4 = new Intent(TratamientoDiferenciadoSoaActivity.this, ResultadosSaludMentalSoa.class);
